...
export const V4L2_CID_MPEG_CX2341X_VIDEO_CHROMA_SPATIAL_FILTER_TYPE =
...
export const V4L2_CID_MPEG_CX2341X_VIDEO_LUMA_MEDIAN_FILTER_BOTTOM =
...
export const V4L2_CID_MPEG_CX2341X_VIDEO_CHROMA_MEDIAN_FILTER_BOTTOM =
	V4L2_CID_CODEC_CX2341X_BASE + 9;
export const V4L2_CID_MPEG_CX2341X_VIDEO_CHROMA_MEDIAN_FILTER_TOP =
...
export const V4L2_CID_MPEG_MFC51_VIDEO_DECODER_H264_DISPLAY_DELAY_ENABLE =
...
export function V4L2_H264_SPS_HAS_CHROMA_FORMAT(
	sps: InstanceType<typeof v4l2_ctrl_h264_sps>,
): boolean {
...
export const v4l2_vp8_entropy = StructType({
	coeff_probs: new ArrayType(
		new ArrayType(new ArrayType(new ArrayType(ref.types.uint8, V4L2_VP8_COEFF_PROB_CNT), 3), 8),
		4,
	),
