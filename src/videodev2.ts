...
export function V4L2_FIELD_IS_SEQUENTIAL(field: v4l2_field): boolean {
	return field === v4l2_field.V4L2_FIELD_SEQ_TB || field === v4l2_field.V4L2_FIELD_SEQ_BT;
}
...
export const V4L2_PIX_FMT_Y10P = v4l2_fourcc(
	"Y",
	"1",
	"0",
	"P",
...
export const V4L2_PIX_FMT_M420 = v4l2_fourcc(
	"M",
	"4",
	"2",
	"0",
...
export const V4L2_PIX_FMT_HM12 = v4l2_fourcc(
	"H",
	"M",
	"1",
	"2",
...
export const V4L2_PIX_FMT_NV12MT = v4l2_fourcc(
	"T",
	"M",
	"1",
	"2",
); /* 12  Y/CbCr 4:2:0 64x32 macroblocks */
export const V4L2_PIX_FMT_NV12MT_16X16 = v4l2_fourcc(
	"V",
	"M",
	"1",
	"2",
...
export const V4L2_PIX_FMT_H264_NO_SC = v4l2_fourcc(
	"A",
	"V",
	"C",
	"1",
...
export const V4L2_PIX_FMT_MPEG2_SLICE = v4l2_fourcc(
	"M",
	"G",
	"2",
	"S",
...
export const V4L2_PIX_FMT_VC1_ANNEX_G = v4l2_fourcc(
	"V",
	"C",
	"1",
	"G",
); /* SMPTE 421M Annex G compliant stream */
export const V4L2_PIX_FMT_VC1_ANNEX_L = v4l2_fourcc(
	"V",
	"C",
	"1",
	"L",
...
export const V4L2_PIX_FMT_FWHT = v4l2_fourcc(
	"F",
	"W",
	"H",
	"T",
); /* Fast Walsh Hadamard Transform (vicodec) */
export const V4L2_PIX_FMT_FWHT_STATELESS = v4l2_fourcc(
	"S",
	"F",
	"W",
	"H",
...
export const V4L2_PIX_FMT_CIT_YYVYUY = v4l2_fourcc(
	"C",
	"I",
	"T",
	"V",
); /* one line of Y then 1 line of VYUY */
export const V4L2_PIX_FMT_KONICA420 = v4l2_fourcc(
	"K",
	"O",
	"N",
	"I",
...
export const V4L2_PIX_FMT_S5C_UYVY_JPG = v4l2_fourcc(
	"S",
	"5",
	"C",
	"I",
); /* S5C73M3 interleaved UYVY/JPEG */
export const V4L2_PIX_FMT_Y8I = v4l2_fourcc(
	"Y",
	"8",
	"I",
	" ",
); /* Greyscale 8-bit L/R interleaved */
export const V4L2_PIX_FMT_Y12I = v4l2_fourcc(
	"Y",
	"1",
	"2",
	"I",
...
export const V4L2_PIX_FMT_MT21C = v4l2_fourcc(
	"M",
	"T",
	"2",
	"1",
); /* Mediatek compressed block mode  */
export const V4L2_PIX_FMT_INZI = v4l2_fourcc(
	"I",
	"N",
	"Z",
	"I",
); /* Intel Planar Greyscale 10-bit and Depth 16-bit */
export const V4L2_PIX_FMT_SUNXI_TILED_NV12 = v4l2_fourcc(
	"S",
	"T",
	"1",
	"2",
); /* Sunxi Tiled NV12 Format */
export const V4L2_PIX_FMT_CNF4 = v4l2_fourcc(
	"C",
	"N",
	"F",
	"4",
...
export const V4L2_PIX_FMT_IPU3_SBGGR10 = v4l2_fourcc(
	"i",
	"p",
	"3",
	"b",
); /* IPU3 packed 10-bit BGGR bayer */
export const V4L2_PIX_FMT_IPU3_SGBRG10 = v4l2_fourcc(
	"i",
	"p",
	"3",
	"g",
); /* IPU3 packed 10-bit GBRG bayer */
export const V4L2_PIX_FMT_IPU3_SGRBG10 = v4l2_fourcc(
	"i",
	"p",
	"3",
	"G",
); /* IPU3 packed 10-bit GRBG bayer */
export const V4L2_PIX_FMT_IPU3_SRGGB10 = v4l2_fourcc(
	"i",
	"p",
	"3",
	"r",
...
/* Meta-data formats */
export const V4L2_META_FMT_VSP1_HGO = v4l2_fourcc(
	"V",
	"S",
	"P",
	"H",
); /* R-Car VSP1 1-D Histogram */
export const V4L2_META_FMT_VSP1_HGT = v4l2_fourcc(
	"V",
	"S",
	"P",
	"T",
...
export const V4L2_META_FMT_D4XX = v4l2_fourcc(
	"D",
	"4",
	"X",
	"X",
...
export const V4L2_META_FMT_RK_ISP1_PARAMS = v4l2_fourcc(
	"R",
	"K",
	"1",
	"P",
); /* Rockchip ISP1 3A Parameters */
export const V4L2_META_FMT_RK_ISP1_STAT_3A = v4l2_fourcc(
	"R",
	"K",
	"1",
	"S",
...
export function V4L2_CTRL_ID2CLASS(id: number) {
	return id & 0x0fff0000;
}
export function V4L2_CTRL_ID2WHICH(id: number) {
	return id & 0x0fff0000;
}
export function V4L2_CTRL_DRIVER_PRIV(id: number) {
...
export const ioctl = constants_native.ioctl as {
	...
	VIDIOC_DBG_S_REGISTER: number;
	VIDIOC_DBG_G_REGISTER: number;
	VIDIOC_S_HW_FREQ_SEEK: number;
	VIDIOC_S_DV_TIMINGS: number;
	VIDIOC_G_DV_TIMINGS: number;
	VIDIOC_DQEVENT: number;
	VIDIOC_SUBSCRIBE_EVENT: number;
	VIDIOC_UNSUBSCRIBE_EVENT: number;
	VIDIOC_CREATE_BUFS: number;
	VIDIOC_PREPARE_BUF: number;
	VIDIOC_G_SELECTION: number;
	VIDIOC_S_SELECTION: number;
	VIDIOC_DECODER_CMD: number;
	VIDIOC_TRY_DECODER_CMD: number;
	VIDIOC_ENUM_DV_TIMINGS: number;
	VIDIOC_QUERY_DV_TIMINGS: number;
	VIDIOC_DV_TIMINGS_CAP: number;
	VIDIOC_ENUM_FREQ_BANDS: number;
	VIDIOC_DBG_G_CHIP_INFO: number;
	VIDIOC_QUERY_EXT_CTRL: number;
};
